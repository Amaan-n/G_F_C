            ...
            <table class="table table-bordered table-striped shadow p-3 mb-5 bg-body rounded" id="table">
                ...
                <tbody style="text-align: center;">
                    ...
                    <tr>
                        ...
                        <td>Mr. {{$detail->father->name}}</td>
                        <td>Mr. {{$detail->father->grandfathers->name}}</td>
                        <td>
                            ...
                            data-age="{{ $detail->age }}"
                            data-fatherid="{{ $detail->father->id }}"
                            data-grandfatherid="{{ $detail->father->grandfathers->id }}"
...
@include("modals.child.add_child")
@include("modals.child.edit_child")
@include("modals.child.delete_child")
@endsection
...
@push('script')
    <script>
       ...
       $(document).on('click', '#edit', function () {
            ...
            let fatherId = $(this).data('fatherid');
